...
const DetailedCardHeader = (props) => {
    const { meta, content, searchQuery, performSearchByPathToFile, performSearchByAuthor } = props
    ...
    return (
        <div style={headerContainerStyle}>
                ...
                <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <div>
                            ...
                            />
                            <span>
                                {content.author && <span style={{ paddingRight: '3px' }}>by&nbsp;
            ...
            <div>{meta.updated_datetime && <span>Last modified: <UpdatedDateTimeLabel meta={meta} searchQuery={searchQuery} formatFunc={getHumanizedTime} /></span>}</div>
        </div>
    )
}
